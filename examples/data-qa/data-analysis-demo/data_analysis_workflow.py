...
from data_visualization_agent import DataVisualizationAgent, DataVisualizationConfig, DataVisualizationTool, ResultsHelperTool
from data_processing_agent import DataProcessingAgent, DataProcessingConfig, PandasProcessTool
from data_regression_agent import DataRegressionAgent, DataRegressionTool, DataRegressionConfig
...
@app.command()
def main(
    debug: bool = typer.Option(False, "--debug", "-d", help="Enable debug mode", is_flag=True),
    no_stream: bool = typer.Option(False, "--nostream", "-ns", help="Disable streaming", is_flag=True),
    nocache: bool = typer.Option(False, "--nocache", "-nc", help="Disable cache", is_flag=True),
    ...
    main_task.add_sub_task([data_cleanup_task, data_visualization_task, data_regression_task])
