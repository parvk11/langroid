...
class ResultsHelperTool(lr.ToolMessage):
    ...
    purpose: str = "Access the information about the results DataFrame for model predictions"
...
class DataVisualizationTool(lr.ToolMessage):
    ...
    def examples(cls) -> list["DataVisualizationTool"]:
        return [
            ...
            cls(expression="df.plot(kind='scatter', x='fatalities_85_99', y='fatalities_00_14')"),
            cls(expression="results_df.plot(x='Actual', y='Predicted', kind='scatter')"),
